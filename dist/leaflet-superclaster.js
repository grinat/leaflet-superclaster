...
// EXTERNAL MODULE: ./src/SuperclusterWorker.js
var SuperclusterWorker = __webpack_require__(1);
var SuperclusterWorker_default = /*#__PURE__*/__webpack_require__.n(SuperclusterWorker);
...
var SuperclusterGroup = external_L_["SuperclusterGroup"] = external_L_["FeatureGroup"].extend({
  options: {
  ...
  _initWorker: function _initWorker() {
    ...
    this._worker = new SuperclusterWorker_default.a();
  ...
  _createGeoJsonLayer: function _createGeoJsonLayer() {
    ...
    this._geoJsonLayer = external_L_["geoJson"](null, {
  ...
  _checkAndKeepPoint: function _checkAndKeepPoint(layer) {
    if (layer instanceof external_L_["Marker"] && !layer.feature.properties.subCluster) {
  ...
  moveToLastKept: function moveToLastKept() {
    ...
    var bounds = external_L_["latLngBounds"](layer.getLatLng().toBounds(distMin * this.options.moveToLastKeptBoundsMultiplier));
  ...
  _removeOrUpdateLayer: function _removeOrUpdateLayer(l, featureIdMap, propKey) {
    ...
    if (featureIdMap[id]) {
      // update marker pos
      l.setLatLng(new external_L_["LatLng"](featureIdMap[id].geometry.coordinates[1], featureIdMap[id].geometry.coordinates[0]));
  ...
  _pointToLayer: function _pointToLayer(feature, latlng) {
    ...
    if (isCluster) {
      return external_L_["marker"](latlng, {
  ...
  _clusterIconFunc: function _clusterIconFunc(feature) {
    return new external_L_["DivIcon"]({
  ...
  _createMarkersInCluster: function _createMarkersInCluster(parentLayer, features, legs) {
    ...
    parentLayer._openedClusterLayer = external_L_["geoJson"]([].concat(_toConsumableArray(features), _toConsumableArray(legs)), {
      pointToLayer: this._pointToLayer.bind(this),
    ...
    parentLayer._openedClusterLayer.on('click', function (_ref8) {
      ...
      // detect is a point
      if (layer instanceof external_L_["Marker"]) {
  ...
  _getDistanceFromMapCenter: function _getDistanceFromMapCenter() {
    ...
    var centerEast = external_L_["latLng"](center.lat, bounds.getEast());
    var distCenterToEast = center.distanceTo(centerEast);
    var centerNorth = external_L_["latLng"](bounds.getNorth(), center.lng);
  ...
  _createSpiral: function _createSpiral(features, parentCenter) {
    ...
    for (i = count; i >= 0; i--) {
      ...
      if (i < count) {
        p = new external_L_["Point"](centerPt.x + legLength * Math.cos(angle), centerPt.y + legLength * Math.sin(angle))._round();
